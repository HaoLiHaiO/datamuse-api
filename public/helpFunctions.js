...
export const renderWordResponse = (res) => {
...
export const renderRawWordResponse = (res) => {
...
export const renderJsonWordResponse = (res) => {
...
export const renderByteResponse = (res) => {
  if (res.errors) {
...
export const renderRawByteResponse = (res) => {
  if (res.errors) {
